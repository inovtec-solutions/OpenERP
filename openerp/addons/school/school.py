...
class student_student(osv.Model):
    ...
    def _calc_age(self, cr, uid, ids, name, arg, context=None):
        ...
        for student in self.browse(cr, uid, ids, context=context):
            start = datetime.strptime(student.birthdate, DEFAULT_SERVER_DATE_FORMAT)
    ...
    _columns = {
        ...
        'cast_id':fields.many2one('student.cast', 'Cast'),
        ...
        'birthdate': fields.date('Birthdate', size=64, required=True, states={'done':[('readonly', True)]}),
#        'date_of_birth':fields.date('Birthdate', required=True, states={'done':[('readonly',True)]}),
        ...
        'age':fields.function(_calc_age, method=True, required=True, string='Age', readonly=True, type="integer"),
        'maritual_status':fields.selection([('unmarried', 'Unmarried'), ('married', 'Married')], 'Maritual Status', required=True, states={'done':[('readonly', True)]}),
        ...
        'contact_email':fields.related('student_id', 'user_email', type='char', relation='student.student', string='Email', readonly=True),
...
class student_family_contact(osv.Model):
    ...
    _columns = {
        ...
        'stu_name':fields.related('user_id', 'name', type='many2one', relation='student.student', string='Name', help="Select Student From Existing List", required=True),
